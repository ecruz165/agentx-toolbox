...
1. Verify npm active in tools manifest:
   ...
   if [ "$ACTIVE" != "true" ]; then
     echo "npm not active. Run /tools:setup npm"
     exit 1
   fi
   ```
...
/tools:npm "install dependencies"

# Add a dev dependency with exact version
/tools:npm "add @biomejs/biome as exact dev dependency"

# Show outdated
/tools:npm "show me outdated packages"

# Run a script
/tools:npm "run the build script"

# Publish a package
/tools:npm "publish this package with public access"

# Audit
/tools:npm "scan for security vulnerabilities"

# Workspace operation
/tools:npm "install lodash in the engineer workspace"
```
...
- Tool installation flows in /tools:setup

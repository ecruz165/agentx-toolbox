...
When invoked: `/core:workflows:manage start market:<workflow-slug>`.
...
```
/core:workflows:manage start market:marketing-calendar-annual
```
...
```
/core:workflows:manage start market:marketing-calendar-monthly
```
...
```
/core:workflows:manage start market:reactivation-campaign
```

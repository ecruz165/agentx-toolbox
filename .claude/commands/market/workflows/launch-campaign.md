---
type: workflow
outcome: Launch a coordinated campaign
...
**Mark complete**: `/core:workflows:manage complete campaign-brief`
...
**Mark complete**: `/core:workflows:manage complete research-check`
...
```bash
/core:frameworks:heroui:build-components design/templates/landing-<slug>.pen
...
**Mark complete**: `/core:workflows:manage complete landing-page`
...
**Mark complete**: `/core:workflows:manage complete seo-update`
...
**Mark complete**: `/core:workflows:manage complete email-sequence`
...
**Mark complete**: `/core:workflows:manage complete ad-campaigns`
...
**Mark complete**: `/core:workflows:manage complete press-release`
...
**Mark complete**: `/core:workflows:manage complete social-organic`
...
**Mark complete**: `/core:workflows:manage complete coordination`
...
**Mark complete**: `/core:workflows:manage complete post-launch-retro`
...
with `/core:workflows:manage resume`. Each phase's completion

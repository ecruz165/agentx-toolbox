---
type: workflow
outcome: Iterate on in-flight story
...
**Mark complete**: `/core:workflows:manage complete identify-feedback`
...
**Mark complete**: `/core:workflows:manage complete refine-upstream`
...
**Mark complete**: `/core:workflows:manage complete re-derive`

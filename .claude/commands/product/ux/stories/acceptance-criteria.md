---
outcome: Add story acceptance criteria
...
Next steps:
  - Create Jira ticket from this story (when integrations:jira configured):
    /core:integrations:jira create-from-story story-export-compliance-pdf
...
When `/core:integrations:jira` (or similar) is configured, refining

...
**Mark complete**: `/workflows:manage complete brief`
...
**Mark complete**: `/workflows:manage complete user-stories`
...
**Mark complete**: `/workflows:manage complete explore`
...
**Mark complete**: `/workflows:manage complete design-page`
...
- **Phase 6 build fails on missing imports**: the page references
  ...
  `/frameworks:heroui:build-components --include-patterns` first to

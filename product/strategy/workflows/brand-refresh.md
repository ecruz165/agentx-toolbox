...
**Mark complete**: `/workflows:manage complete pre-refresh-snapshot`
...
**Mark complete**: `/workflows:manage complete define-scope`
...
**Mark complete**: `/workflows:manage complete re-select`
...
**Mark complete**: `/workflows:manage complete foundation-cascade`
...
```bash
/frameworks:heroui:build-components --foundation-only --rebuild
```
...
**Mark complete**: `/workflows:manage complete component-rebuild`
...
**Mark complete**: `/workflows:manage complete pattern-template-cascade`
...
# Then rebuild React:
/frameworks:heroui:build-components --rebuild
```
...
**Mark complete**: `/workflows:manage complete page-regeneration`
...
**Mark complete**: `/workflows:manage complete ship`

...
**Mark complete**: `/workflows:manage complete inventory`
...
**Mark complete**: `/workflows:manage complete convert-fig`
...
**Mark complete**: `/workflows:manage complete reconcile-foundations`
...
for group in surfaces buttons forms feedback overlays navigation; do
  /frameworks:heroui:components:$group \
...
**Mark complete**: `/workflows:manage complete reconcile-components`
...
**Mark complete**: `/workflows:manage complete audit-verify`

...
**Mark complete**: `/workflows:manage complete identify-scope`
...
**Mark complete**: `/workflows:manage complete pre-export-prep`
...
**Mark complete**: `/workflows:manage complete export-and-hand-off`
...
- **Week 2+ overdue**: pause the workflow and continue brownfield
  work in parallel — `/workflows:manage pause` saves the state for
...
**Mark complete**: `/workflows:manage complete review-returned`
...
**Mark complete**: `/workflows:manage complete diff-merge-import`
...
```bash
/frameworks:heroui:build-components <artifact-slug>
```
...
**Mark complete**: `/workflows:manage complete rebuild-verify`
...
- **Paused mid-Phase 4 (waiting for designer)**: this is the
  expected pause point. `/workflows:manage status` shows "out for

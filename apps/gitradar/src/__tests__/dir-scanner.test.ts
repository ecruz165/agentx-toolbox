...
describe('scanDirectory', () => {
  ...
  it('skips directories without .git', async () => {
    mockReaddir.mockResolvedValueOnce([dirent('has-git', true), dirent('no-git', true)] as any);
  ...
  it('discovers repos at depth 2', async () => {
    ...
    mockReaddir.mockResolvedValueOnce([dirent('acme', true)] as any);
  ...
  it('does not descend into git repos', async () => {
    mockReaddir.mockResolvedValueOnce([dirent('repo-with-submodule', true)] as any);
  ...
  it('defaults to depth 1', async () => {
    mockReaddir.mockResolvedValueOnce([dirent('org-dir', true)] as any);

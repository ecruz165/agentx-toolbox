/**
 * Pritty's auth surface — a thin layer over @agentx/agent-auth.
 *
 ...
 * those primitives live in @agentx/agent-auth (a toolbox-shared
 ...
 * keychain), it lands in @agentx/agent-auth and every consuming app

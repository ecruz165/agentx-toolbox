...
- **Never** code edits to source files (component code,
  ...
  appropriate command (`/core:frameworks:heroui:build-components`,
...
Plane 1 — Code drift (product persona)
  src/components/Button.tsx
    ...
    Action:  Run /core:frameworks:heroui:build-components --component Button
...
Plane 11 — Maintenance drift (engineer persona)
  Sub-check: 11b upgrade lag
    ...
    Action:  Run /core:workflows:manage start engineer:polyglot-maintenance-cycle
...
- **Dispatch follow-up workflows.** When findings suggest
  ...
  The user invokes `/core:workflows:manage start` if they choose.

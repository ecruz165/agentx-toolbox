...
- **`/core:workflows:manage start engineer:adr-cycle`** — when
  ...
  to a Teams channel
- **`/core:integrations:datadog`** etc. (when configured) — alert
...
/core:integrations:teams "list my teams and channels"

# Read recent messages
/core:integrations:teams "show recent messages in the development channel"

# Post update
/core:integrations:teams "post to development channel: PR #1247 ready for review"

# Post with mention
/core:integrations:teams "tell Sarah in development channel that the PR is ready"

# Search
/core:integrations:teams "find messages about the staging outage"

# Create meeting
/core:integrations:teams "create a Teams meeting for tomorrow 2-3pm titled 'Architecture review'"

# Read DM history
/core:integrations:teams "show my chat with Sarah from this week"
```

---
outcome: Introduce a new capability
...
Out of scope (deferred or alternative capability):
  ...
  - Email notifications (handled by /core:integrations:email)
...
work happens outside this workflow — typically:
  - Create implementation tickets in /core:integrations:jira
  - Assign to engineering team
  - Track progress via /core:integrations:github (PRs)

When implementation is complete, return here:
  /core:workflows:manage complete engineer:capability-introduction
...
# Resume in-progress
/core:workflows:manage continue engineer:capability-introduction

---
type: workflow
outcome: Run a seasonal campaign
...
**Mark complete**: `/core:workflows:manage complete pre-flight-moment`
...
/core:frameworks:heroui:build-components design/templates/landing-seasonal-<season-slug>.pen
```
...
**Mark complete**: `/core:workflows:manage complete sunset`
...
**Mark complete**: `/core:workflows:manage complete post-season-retro`

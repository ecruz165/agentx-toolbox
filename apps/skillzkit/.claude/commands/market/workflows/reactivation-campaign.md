---
type: workflow
outcome: Run user reactivation campaign
...
**Mark complete**: `/core:workflows:manage complete pre-flight-audience`
...
**Mark complete**: `/core:workflows:manage complete retargeting`
...
/core:frameworks:heroui:build-components design/templates/landing-reactivate-<slug>.pen
...
**Mark complete**: `/core:workflows:manage complete coordination-cadence`
...
**Mark complete**: `/core:workflows:manage complete execution`
...
**Mark complete**: `/core:workflows:manage complete suppression`
...
**Mark complete**: `/core:workflows:manage complete post-campaign-retro`

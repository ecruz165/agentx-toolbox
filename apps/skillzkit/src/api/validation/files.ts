...
export function validateFileBundle(req: CreateContributionRequest): ReviewFinding[] {
...
function validateFileCount(files: ContributionFile[], findings: ReviewFinding[]): void {
  if (files.length === 0) {
    findings.push({
      severity: 'high',
      axis: 'bundle',
...
function validateStructuredFile(file: ContributionFile, findings: ReviewFinding[]): void {

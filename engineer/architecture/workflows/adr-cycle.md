...
**Invoke with:** `/workflows:manage start engineer:adr-cycle`
...
The workflow will track stakeholder feedback. To collect:
  ...
  3. Return here and run:
     /workflows:manage continue engineer:adr-cycle
     OR
     /workflows:manage record-feedback engineer:adr-cycle
```
...
When all stakeholders have given final acceptance, run:
  /workflows:manage accept engineer:adr-cycle

If new concerns surface, return to refining:
  /workflows:manage refine engineer:adr-cycle
```
...
When user re-invokes `/workflows:manage start engineer:adr-cycle`
...
```bash
/workflows:manage start engineer:adr-cycle --phase refining
```
...
```bash
/workflows:manage abort engineer:adr-cycle
```
...
```bash
# Start new cycle
/workflows:manage start engineer:adr-cycle "Choose orchestration framework"

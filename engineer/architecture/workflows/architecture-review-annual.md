...
**Invoke with:**
`/workflows:manage start engineer:architecture-review-annual`
...
When all walkthroughs complete:
  /workflows:manage walkthrough-complete engineer:architecture-review-annual
```
...
Priority 2: Spring Modulith boundary cleanup
  Type: refactor
  Follow-up: technical task tracked in /integrations:jira
              SCOOL-XXXX
...
- **`/workflows:manage start engineer:adr-cycle`** in Phase 5
...
- **`/integrations:jira`** for ticketing commitments
- **`/integrations:gcal`** for checkpoint reminders
...
# Resume in-progress
/workflows:manage continue engineer:architecture-review-annual

# Specific year (e.g., re-running a past year for analysis)
/workflows:manage start engineer:architecture-review-annual --year 2025

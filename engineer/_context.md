...
When invoked: `/workflows:manage start engineer:<workflow-slug>`.
...
```
/workflows:manage start engineer:capability-introduction  (when built)
```
...
```
/workflows:manage start engineer:architecture-review-annual  (when built)
```

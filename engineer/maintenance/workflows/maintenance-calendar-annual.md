...
**Mark complete**: `/workflows:manage complete preflight-capacity`
...
**Mark complete**: `/workflows:manage complete capacity-input`
...
**Mark complete**: `/workflows:manage complete cadence-targets`
...
**Mark complete**: `/workflows:manage complete compliance-cadence`
...
**Mark complete**: `/workflows:manage complete risk-tolerance`
...
// product/.pencil-maintenance-calendar.json
{
  ...
  "last_updated_by": "/workflows:manage start engineer:maintenance-calendar-annual",
  ...
  "checkpoints": [
    ...
    },
    {
      ...
      "purpose": "Re-run /workflows:manage start engineer:maintenance-calendar-annual"
    }
  ]
}
```
...
**Mark complete**: `/workflows:manage complete persist-manifest`
...
**Mark complete**: `/workflows:manage complete strategy-doc`
...
Next steps:
1. Run first cycle: /workflows:manage start engineer:polyglot-maintenance-cycle

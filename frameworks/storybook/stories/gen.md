...
/frameworks:storybook:stories:gen components/core/atoms/button/Button.tsx

# Update existing stories (refresh after API changes)
/frameworks:storybook:stories:gen Button --update

# Limit variants generated
/frameworks:storybook:stories:gen Button --variants size,color

# Skip interaction tests
/frameworks:storybook:stories:gen Modal --no-interaction-tests
```

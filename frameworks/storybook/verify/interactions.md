...
No interaction tests defined in this scope. To add:
  /frameworks:storybook:stories:gen Button --include-interaction-tests
```
...
core-atoms-input--debounced
  ...
  Debug: re-run with --debug to watch the interaction unfold:
    /frameworks:storybook:verify:interactions core-atoms-input--debounced --debug
...
Next steps:
  - Investigate failures with /frameworks:storybook:verify:fix
  - Re-run after fixes
```
...
- **Generate play functions.** Story generation
  (`/frameworks:storybook:stories:gen`) creates play functions
...
# Specific component
/frameworks:storybook:verify:interactions Button

# Specific story
/frameworks:storybook:verify:interactions core-atoms-button--click-handler

# Debug mode (visible browser)
/frameworks:storybook:verify:interactions core-atoms-button--click-handler --debug

# Run against deployed storybook
/frameworks:storybook:verify:interactions atoms --source deployed

# CI integration
/frameworks:storybook:verify:interactions --json > interactions.json
```

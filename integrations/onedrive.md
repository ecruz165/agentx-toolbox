...
To download: /integrations:onedrive "download tournament-revenue-q1.xlsx"
To share: /integrations:onedrive "create a view link for product-roadmap-2026.docx"
```
...
For more, refine search:
  /integrations:onedrive "search for ferpa compliance from 2026"
```
...
/integrations:onedrive "list files in /Documents/skoolscout"

# Search
/integrations:onedrive "find PDFs about FERPA compliance"

# Download
/integrations:onedrive "download q2-report.pdf"

# Upload
/integrations:onedrive "upload /tmp/draft.pdf to /Documents/drafts/"

# Share
/integrations:onedrive "create a view-only link for product-roadmap-2026.docx"

# Recent files
/integrations:onedrive "show me recently accessed files"

# Quota
/integrations:onedrive "how much OneDrive storage am I using"
```

...
1. Verify integration is active:
   ...
   if [ "$ACTIVE" != "true" ]; then
     echo "SEMrush not active. Run /integrations:setup semrush"
     exit 1
   fi
   ```
...
2. Resolve credentials:
   ...
   [ -n "$SEMRUSH_API_KEY" ] || {
     echo "SEMrush API key missing. Run /integrations:setup semrush"
     exit 1
   }
   ```
...
Suggested follow-ups:
  - Domain organic keywords: /integrations:semrush "list top 100 organic keywords for skoolscout.com"
  - Backlinks: /integrations:semrush "show backlinks pointing to skoolscout.com"
  - Competitors: /integrations:semrush "show domain competitors for skoolscout.com"
```
...
Suggested actions:
  - Content gaps: /integrations:semrush "what keywords does powerschool.com rank for that skoolscout.com doesn't"
  - SERP analysis: /integrations:semrush "analyze the SERP for 'ferpa compliance software'"
  - Long-tail: /integrations:semrush "find long-tail variants of 'ferpa compliance' under KD 30"
```
...
| ERROR :: WRONG KEY | Invalid API key | Re-run /integrations:setup semrush |
...
```bash
# Domain overview
/integrations:semrush "show domain overview for skoolscout.com"

# Keyword research
/integrations:semrush "research the keyword 'ferpa compliance software'"

# Competitive analysis
/integrations:semrush "compare skoolscout.com to powerschool.com"

# Long-tail keyword research
/integrations:semrush "find long-tail keywords for 'ferpa compliance' under KD 40"

# Backlink analysis
/integrations:semrush "show backlinks to skoolscout.com"

# Top organic keywords
/integrations:semrush "list top 100 organic keywords for skoolscout.com"

# Question-form keywords (content opportunities)
/integrations:semrush "find question-form keywords about FERPA compliance"

# SERP gap analysis
/integrations:semrush "what keywords does clever.com rank for that skoolscout.com doesn't"
```
